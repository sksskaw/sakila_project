...
public class FilmService {
		...
		public Map<String, Object> getFilmList(int currentPage, int rowPerPage, String searchWord, String category){
			...
			List<FilmListView> filmList = filmListViewMapper.selectFilmList(page);
